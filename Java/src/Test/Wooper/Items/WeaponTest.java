...
class WeaponTest {
    ...
    void setBowHP0(){
        JsonObject item;
        Gson gson = new Gson();
        String testBow = "{\"uuid\":\"e9eb47aa6c164120a09470659bd33f8a\",\"auctioneer\":\"e34f913a48b84b08bdbce0362d37e307\",\"profile_id\":\"31b5991439954facae37f99838299ed7\",\"coop\":[\"e34f913a48b84b08bdbce0362d37e307\"],\"start\":1589030594573,\"end\":1589052194573,\"item_name\":\"Rapid Runaan's Bow\",\"item_lore\":\"§7Damage: §c+180 §e\\n§7Strength: §c+80 §e §8(Rapid +10)\\n§7Crit Damage: §c+50% §8(Rapid +50%)\\n\\n§9Aiming IV, §9Cubism V\\n§9Dragon Hunter III, §9Flame I\\n§9Impaling III, §9Infinite Quiver V\\n§9Piercing I, §9Power V\\n§9Snipe III, §9Telekinesis I\\n\\n§9◆ Wake Rune III\\n§8Requires level 18\\n\\n§6Item Ability: Triple Shot\\n§7Shoots 3 arrows at a time! The 2\\n§7extra arrows deal §a40%\\n§a§7percent of the damage.\\n\\n§6§lLEGENDARY BOW\",\"extra\":\"Rapid Runaan's Bow Bow Impaling Dragon Hunter Piercing Infinite Quiver Telekinesis Power Snipe Flame Aiming Cubism\",\"category\":\"weapon\",\"tier\":\"LEGENDARY\",\"starting_bid\":87095,\"item_bytes\":\"\",\"claimed\":false,\"claimed_bidders\":[],\"highest_bid_amount\":0,\"bids\":[]}";
        item = gson.fromJson(testBow, JsonObject.class);
        bow = new Weapon(item);
    }
    ...
    void getHpBooks() {
        setup();
        assertEquals(10, bow.getHpBooks());
        System.out.println(bow.getHpBooks());
        setBowHP0();
        System.out.println(bow.getHpBooks());
        assertEquals(0, bow.getHpBooks());
    }
}